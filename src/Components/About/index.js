        ...
        <div className='about'>
            <div className='about-section'>
                <div className='about-left'>
                    ...
                    <p className='about-me'>As a web developer, I enjoy using my obsessive attention to detail, my unequivocal love for building things from the ground up, and my mission-driven work ethic to literally change the world. That's why I’m excited to make a big impact at a high growth company.</p>
